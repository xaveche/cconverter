...
function getExchangeRate(){
    ...
    let url = `https://v6.exchangerate-api.com/v6/dfdc2e2c72f84884760fda4b/latest/${fromCurrency.value}`;
    // fetching api response and returning it with parsing into js obj (Using this API as I was not able to access the Assignment Page to grab API)
